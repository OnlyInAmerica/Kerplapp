...
/**
 * The PackageReceiver class extends {@link android.content.BroadcastReceiver}
 * in order to catch Package install broadcasts. Upon receiving a
 * <b>PACKAGE_ADDED</b> or <b>PACKAGE_REPLACED</b> event the PackageReceiver
 * uses {@link Utils} to calculate the UAppID for the package name bundled in
